    ...
    methods: {
        submitForm: function submitForm() {
            ...
            vm.$validator.validateAll().then(function (res) {
                if (res) {
                    var url = __WEBPACK_IMPORTED_MODULE_1__app_constants__["baseUrl"] + '/users/add';
                    if (vm.editing) {
                        url = __WEBPACK_IMPORTED_MODULE_1__app_constants__["baseUrl"] + '/users/edit';
                    }
                    var data = vm.user;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.editing && _vm.errors.has('password')),
      expression: "!editing && errors.has('password')"
    }],
    staticClass: "text-danger"
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.editing && _vm.errors.has('re_password')),
      expression: "!editing && errors.has('re_password')"
    }],
    staticClass: "text-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('re_password')))])]), _vm._v(" "), (_vm.roles && _vm.roles.length) ? _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "form-control-label"
